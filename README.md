...
- **AI 번역** — Claude, OpenAI, Gemini 등 다양한 AI 프로바이더 지원
...
> **번역 기능을 사용하려면 유료 라이선스 키가 필요합니다.**

이 앱의 소스 코드는 MIT 라이선스로 자유롭게 사용할 수 있지만, 번역 서비스는 서버 측 라이선스 검증을 통해 제공됩니다. 라이선스 키 구매에 대한 자세한 내용은 [ClosedClaws](https://closedclaws.com)를 참고하세요.

자체 AI API 키를 사용한 로컬 번역은 라이선스 없이도 설정 가능합니다.
